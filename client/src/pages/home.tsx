...
function ProductCarousel({ products, itemsPerPage = 3 }: { products: ProductType[], itemsPerPage?: number }) {
    ...
    <div className="min-h-screen bg-background font-sans selection:bg-primary/10">
      ...
      <section id="products" className="pt-8 sm:pt-16 pb-16 sm:pb-32 bg-white relative z-20">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24">
          ...
          <ProductCarousel 
            products={curatedProducts.length > 0 ? curatedProducts : fallbackProducts} 
            itemsPerPage={3} 
          />
        </div>
      </section>
      ...
      <section id="bestsellers" className="py-16 sm:py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24">
          ...
          <ProductCarousel 
            products={bestSellerProducts.length > 0 ? bestSellerProducts : fallbackProducts.slice(3)} 
            itemsPerPage={3} 
          />
        </div>
      </section>
      ...
      <footer className="bg-white py-12 sm:py-16 md:py-24 border-t border-border">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 text-center">
          ...
          <div className="flex justify-center gap-4 sm:gap-6 mb-8 sm:mb-12">
             <a href={config.social.instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-colors" data-testid="link-instagram"><Instagram className="w-4 h-4"/></a>
             <a href={config.social.tiktok} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-colors" data-testid="link-tiktok">
               <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
             </a>
             <a href={config.social.whatsapp} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary transition-colors" data-testid="link-whatsapp"><MessageCircle className="w-4 h-4"/></a>
          </div>
