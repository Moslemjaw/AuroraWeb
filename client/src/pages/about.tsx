      ...
      <nav className="sticky top-0 left-0 w-full z-50 px-6 py-6 flex items-center justify-between bg-white border-b border-border/40">
         ...
         <div className="hidden md:flex items-center gap-8">
            <div className="flex gap-8 text-xs font-bold tracking-widest uppercase text-muted-foreground/80">
              ...
              <Link href="/about"><a className="text-primary transition-colors">About Us</a></Link>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 py-20">
        <div className="max-w-3xl mx-auto text-center mb-20 space-y-6">
          ...
          <h1 className="font-serif text-5xl md:text-6xl text-foreground leading-tight">
            Crafting beauty that <span className="italic text-primary">lasts forever.</span>
          </h1>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
              <img src={logoImg} alt="Signature" className="w-16 h-16 opacity-50" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-secondary/10 p-12 md:p-20 text-center space-y-8">
           ...
           <div className="grid md:grid-cols-3 gap-12 pt-8">
             <div className="space-y-4">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">Using eco-friendly materials and reducing waste through upcycling.</p>
             </div>
             <div className="space-y-4">
               <div className="w-12 h-1 bg-primary mx-auto mb-4" />
               <h3 className="font-serif text-xl">Craftsmanship</h3>
               <p className="text-muted-foreground text-sm leading-relaxed">Honoring traditional flower making techniques with modern design.</p>
             </div>
             <div className="space-y-4">
               <div className="w-12 h-1 bg-primary mx-auto mb-4" />
               <h3 className="font-serif text-xl">Timelessness</h3>
               <p className="text-muted-foreground text-sm leading-relaxed">Creating heirlooms that can be passed down through generations.</p>
             </div>
           </div>
        </div>
      </div>
